// -----------------------------------------------------------------------------------------
// <copyright file="AZSContinuationToken.m" company="Microsoft">
...
{
    AZSContinuationToken *token = [[AZSContinuationToken alloc] init];
    token.nextMarker = nextMarker;
    token.storageLocation = storageLocation;
    return token;
}
